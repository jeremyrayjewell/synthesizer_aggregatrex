...
const ZoomControls = ({ 
  ...
  }, [camera, gl, minZoom, maxZoom, zoomStep, pinchSensitivity]);

  // Define the controls that will be rendered via portal
  const controls = (
    <>
      <div 
        style={{
  ...
  // Use React portals to render the controls directly in the body
